...
#align(center)[
  #image("../src/img/exercises/solved/exe3_red.png", width: 75%)S
...
#util.codeBlock("src/lst/test_evaluador.py", lang: "python")
...
#util.codeBlock("src/lst/evaluador.py", lang: "python")
...
#align(center)[
  #image("../src/img/exercises/solved/exe3_green.png", width: 75%)

...
+ *La selección sistemática de casos de prueba es superior al azar.* Aplicar particiones de equivalencia y análisis de valor límite permite construir suites pequeñas pero exhaustivas en los puntos donde estadísticamente se concentran los defectos @myers2012art. Como demuestran los ejercicios, probar los límites exactos (2, 3, 4, 5 extras) detecta errores que una prueba aleatoria difícilmente encontraría.
...
+ *La combinación TDD + BDD maximiza la calidad.* TDD garantiza la corrección técnica interna; BDD garantiza que el software entregue el valor de negocio esperado. Usados juntos conforman una estrategia de pruebas completa que cubre tanto la micro-validación del código como la validación de los requisitos del usuario final @spillner2021foundations.

...
| Integrante | Username Git | Perfil de Desempeño | Tarea Asignada |
| :--- | :--- | :--- | :--- |
| **Leonardo Ruben Arce Mayhua** | `Larcem` | Cumple (Estándares bajos) | **Ejercicio 1: Automatización con Supertest** (`ejercicio1_leo.typ`) |
| **Mariel Alisson Jara Mamani** | `Alsnj20` | Eficiente | **Ejercicio 2: Pruebas de Integración - alf.io (Frontera y Resiliencia)** (`ejercicio2_alisson.typ`) |
| **Álvaro Raúl Quispe Condori** | `alvaro9rqc` | Eficiente | **Ejercicio 2: Pruebas de Integración - alf.io (Inyección de Fallas)** (`ejercicio2_alvaro.typ`) |
| **Anette Gallegos** | `Anette-Gallegos` | No eficiente | **Cuestionario, Conclusiones y Compilación Final** (`cuestionario.typ`, `conclusiones.typ`) |
...
* **Parte 1 (Asignada a Alisson `Alsnj20`):**
  ...
  * **Tareas:** 
    ...
    2. **Caso 3 (Resiliencia):** Diseñar y ejecutar (o documentar en base a los tests del repositorio, como `StripeReservationFlowIntegrationTest`) un test que evalúe qué ocurre cuando hay un *Timeout* o fallo de conexión/firma con la pasarela de pagos simulada (Webhook). Completar la tabla de discrepancias con el resultado real.

...
#align(center)[
  ...
  #table(
    ...
    [Resiliencia (Caso 3)], [Simulación de timeout y alta latencia en webhook de Stripe (pago externo).], [Pendiente / En pruebas (el resultado real se registrará tras la ejecución).]
  )
]

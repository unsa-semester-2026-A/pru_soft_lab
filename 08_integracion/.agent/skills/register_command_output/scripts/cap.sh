...
###############################################################################
# Nombre del script: cap.sh
# Descripción: Ejecuta comandos y crea una imagen mostrándo sus resultados, como si fueron introducidos manualmente en la terminal
# Autor: Christian Mestaz, Alvaro Quispe
# Fecha: 2026-05-01
# Uso: ./cap.sh nombre_sin_extensión "comandos"
# Salida: Dos archivos, un png con la imágen y un .log con los datos devueltos
###############################################################################

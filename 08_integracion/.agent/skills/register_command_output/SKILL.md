...
- Use the script in `.agent/skills/register_command_output/scripts/cap.sh` 
- Example `.agent/skills/register_command_output/scripts/cap.sh file-name 'command1' 'command2'`

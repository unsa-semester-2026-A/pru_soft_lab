...
- `informe/util/`:
  ...
  - `cap.sh`: Script para la captura o ejecución de procesos. **Nota: No se pueden utilizar scripts interactivos con `cap.sh` ya que espera procesos no bloqueantes o que se ejecuten automáticamente.**
